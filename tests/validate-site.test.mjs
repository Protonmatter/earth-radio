...
async function createSite(root, { config = "window.RADIO_CONFIG={proxyBaseUrl: desktopProxyBaseUrl || ''};", missingAsset = false } = {}) {
  ...
  if (!missingAsset) await writeFile(path.join(root, 'assets', 'app.js'), 'export {};\n');
